...
const descriptions = {
	...
	descriptions: {
		...
		medicine: {
			groups: 'Здесь вы можете добавить группы лекарств, которые будут доступны при заполнении эпикриза.',
			drugs: 'Здесь вы можете ввести лекарства, которые будут доступны при заполнении эпикриза.',
		},

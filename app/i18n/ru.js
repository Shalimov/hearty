...
const descriptions = {
	...
	errors: {
		noAnalyses: 'Для заполнения выписки необходимо иметь как минимум один анализ в графе анализы.',
		noMedicine: 'Для заполнения выписки необходимо иметь как минимум одно лекарственное средство в графе лекарства.',
	},
